  ...
  return (
    <div className="bg-white text-black min-h-screen flex flex-col justify-start px-4 md:px-8 lg:px-12 lg:mt-0 md:mt-0 mt-10">
      ...
      <div className="mt-4 w-full">
        ...
        onClick={() => handleScrollToSection("prototype")}>
          ...
          <div className="bg-[#FDF9F8] border-[#ECECEC] border-4 w-full h-auto md:h-[710px] p-4 md:p-8 lg:px-56">
            <div className="flex justify-center items-center h-full">
              <iframe
                width="1000"
                height="450"
                src="https://embed.figma.com/proto/5cVerx1YVek5mRGlFhUN5T/Biotech-Malli(OG)?node-id=1014-608&starting-point-node-id=1014%3A608&embed-host=share"
              ></iframe>
            </div>
          </div>
        </div>
