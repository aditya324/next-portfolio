          ...
          <div className="bg-[#FDF9F8] border-[#ECECEC] border-4 w-full h-auto md:h-[710px] p-4 md:p-8 lg:px-56">
            <div className="flex justify-center items-center h-full">
              <iframe
                ...
                width="1000"
                height="450"
                src="https://embed.figma.com/proto/ZqD2kB940tRunqxkDrbHkw/Move-On-Wheels---customer-side?node-id=105-16136&amp;scaling=scale-down-width&amp;content-scaling=fixed&amp;page-id=0%3A1&amp;starting-point-node-id=1%3A2&amp;embed-host=share"
